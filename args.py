...
def args_parser():
    ...
    parser.add_argument("--alie_scale", type=float, default=1, 
    ...
    parser.add_argument("--gamma_c", type=float, default=1.0, 
                        help="para for Sine attack: cosine scaling factor")
    parser.add_argument("--gamma_n", type=float, default=100.0, 
                        help="para for Sine attack: norm scaling factor")
